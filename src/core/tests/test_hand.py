...
class HandTest(unittest.TestCase):
    def _assert_balanced(self, hand_string, balanced):
        self.assertEqual(Hand.from_cdhs_string(
            hand_string).is_balanced(), balanced)
    ...
    def _assert_flat(self, hand_string, flat):
        self.assertEqual(Hand.from_cdhs_string(hand_string).is_flat(), flat)
    ...
    def _assert_non_working_honor_adjustment(self, hand_string, trump, expected_adjustment):
        ...
        self.assertEqual(hand._support_point_adjustment_for_non_working_honors(
            trump), expected_adjustment)

    def test_support_point_adjustment_for_non_working_honors(self):
        self._assert_non_working_honor_adjustment(
            "AKJ52.J.J9743.54", HEARTS, -1)
        self._assert_non_working_honor_adjustment(
            "AKJ52.Q.J9743.54", HEARTS, -2)
        self._assert_non_working_honor_adjustment(
            "AKJ52.K.J9743.54", HEARTS, -3)
        self._assert_non_working_honor_adjustment(
            "AKJ52.A.J9743.54", HEARTS, 0)
        self._assert_non_working_honor_adjustment(
            "AKJ52.KQ.J974.54", HEARTS, -2)
        self._assert_non_working_honor_adjustment(
            "AKJ52.KJ.J974.54", HEARTS, -1)
        self._assert_non_working_honor_adjustment(
            "AKJ52.K9.J974.54", HEARTS, 0)
        self._assert_non_working_honor_adjustment(
            "AKJ52.QJ.J974.54", HEARTS, -3)
        self._assert_non_working_honor_adjustment(
            "AKJ52.Q9.J974.54", HEARTS, -2)

    def test_support_points(self):
        self.assertEqual(Hand.from_cdhs_string(
            "AKJ52.J.J9743.54").support_points(HEARTS), 13)
        self.assertEqual(Hand.from_cdhs_string(
            "AKJ52.J.J9743.54").generic_support_points(), 13)
        self.assertEqual(Hand.from_cdhs_string(
            "AKJ52..J9743.J54").generic_support_points(), 15)

    def _hand_with_clubs(self, clubs_string):
        spade_filler_string = 'AKQJT98765432'
        hand_string = clubs_string + '...' + \
            spade_filler_string[:-len(clubs_string)]
    ...
    def _assert_stopper(self, cards_string, expected_round):
        ...
        self.assertEqual(hand.has_fourth_round_stopper(CLUBS),
                         bool(expected_round) and expected_round <= 4)
        self.assertEqual(hand.has_third_round_stopper(CLUBS),
                         bool(expected_round) and expected_round <= 3)
        self.assertEqual(hand.has_second_round_stopper(CLUBS),
                         bool(expected_round) and expected_round <= 2)
        self.assertEqual(hand.has_first_round_stopper(CLUBS),
                         bool(expected_round) and expected_round <= 1)
    ...
    def test_shdc_dot_string(self):
        ...
        self.assertEqual(hand.cdhs_dot_string(), cdhs_dot_string)
        self.assertEqual(hand.shdc_dot_string(), "54.J9743.J.AKJ52")
