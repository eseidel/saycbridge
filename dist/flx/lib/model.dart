...
enum Positions { west, north, east, south }

class CallHistory {
  CallHistory({this.calls: const [], this.dealer: Positions.north});
  ...
  Positions getPositionForIndex(int index) {
    return Positions.values[(dealer.index + index) % Positions.values.length];
  }
